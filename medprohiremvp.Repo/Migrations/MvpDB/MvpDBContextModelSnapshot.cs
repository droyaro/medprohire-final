...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("medprohiremvp.DATA.Entity.ApiKeys", b =>
                {
            ...
            modelBuilder.Entity("medprohiremvp.DATA.Entity.ApplicantAppliedShiftsDays", b =>
                {
                    b.Property<int>("AppliedShiftDay_ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("AppliedShiftDay_ID");

                    b.HasIndex("AppliedShift_ID");

                    b.ToTable("ApplicantAppliedShiftsDays");
                });
            ...
            modelBuilder.Entity("medprohiremvp.DATA.Entity.ClientCostChanges", b =>
                {
                    b.Property<int>("ClientCostChanges_ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("medprohiremvp.DATA.Entity.ClientSpecialties", b =>
                {
                    b.Property<int>("ClientSpeciality_ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("medprohiremvp.DATA.Entity.ClientSpecialtiesCosts", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasIndex("ClientSpeciality_ID");

                    b.HasIndex("ShiftLabel_ID");

                    b.ToTable("ClientSpecialtiesCosts");
                });
            ...
            modelBuilder.Entity("medprohiremvp.DATA.Entity.TicketCategories", b =>
                {
                    b.Property<int>("TicketCategory_ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("TicketCategory_ID");

                    b.ToTable("TicketCategories");
                });

            modelBuilder.Entity("medprohiremvp.DATA.Entity.TicketContents", b =>
                {
                    b.Property<int>("TicketContent_ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("medprohiremvp.DATA.Entity.Tickets", b =>
                {
                    b.Property<int>("Ticket_ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("medprohiremvp.DATA.Entity.ApplicantAppliedShiftsDays", b =>
                {
                    b.HasOne("medprohiremvp.DATA.Entity.ApplicantAppliedShifts", "appliedShifts")
                        .WithMany("AppliedShiftsDays")
            ...
            modelBuilder.Entity("medprohiremvp.DATA.Entity.ClientSpecialtiesCosts", b =>
                {
                    b.HasOne("medprohiremvp.DATA.Entity.ClientSpecialties", "ClientSpecialties")
                        .WithMany()
                        .HasForeignKey("ClientSpeciality_ID")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("medprohiremvp.DATA.Entity.TicketContents", b =>
                {
                    b.HasOne("medprohiremvp.DATA.Entity.Tickets", "ticket")
                        .WithMany()
            ...
            modelBuilder.Entity("medprohiremvp.DATA.Entity.Tickets", b =>
                {
                    b.HasOne("medprohiremvp.DATA.Entity.TicketCategories", "ticketCategories")
                        .WithMany()
                        .HasForeignKey("TicketCategory_ID")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("medprohiremvp.DATA.Entity.ՕperatingApplicants", b =>
            {
                b.Property<int>("Operating_ID")
                       .ValueGeneratedOnAdd()
                       .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                ...
                b.Property<DateTime>("DataChoose");
                
                b.HasKey("Operating_ID");
                
                b.HasIndex("Applicant_ID");
                
                b.HasIndex("ClientShift_ID");
                
                b.ToTable("ՕperatingApplicants");
